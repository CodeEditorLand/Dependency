...
# 	mapfile -t REPOS_ORG_TEMP < <(printf "%s" "$(
# 		gh api \
# 			-H "Accept: application/vnd.github+json" \
# 			-H "X-GitHub-Api-Version: 2022-11-28" \
# 			orgs/"${ORG}"/repos?per_page=100\&page=${PAGE} | jq -r '.[].full_name'
# 	)" | tr -d '\r')

# 	REPOS_ORG+=("${REPOS_ORG_TEMP[@]}")
# done
...
for REPO in "${REPOS[@]}"; do
	cd /d/Developer/Application/CodeEditorLand/Application || exit

	git clone --depth=1 --recurse-submodules --shallow-submodules "ssh://git@github.com/${REPO}"
